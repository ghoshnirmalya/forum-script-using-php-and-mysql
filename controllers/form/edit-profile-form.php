        ...
        <div class="tab-pane fade" id="customize">
            <div class="col-md-6">
                <div class="form-group float-label-control">
                    ...
                    <input name="BackgroundImageFile" type="file" id="uploadBackgroundFile"/>           
                    <div class="col-md-6">
                        <div class="shortpreview">
                            <label for="">Previous Background Picture </label>
                            <br> 
                            <a href="userfiles/background-images/<?php echo $rws['user_backgroundpicture'];?>">
                                <img src="userfiles/background-images/<?php echo $rws['user_backgroundpicture'];?>" class="img-responsive">
                            </a>
                        </div>                    
                    </div>
                    <div class="col-md-6">
                        <div class="shortpreview" id="uploadBackgroundImagePreview">
                            <label for="">Current Uploaded Avatar </label>
                            <br> 
                            <div id="imageBackgroundPreview"></div>
                        </div>
                    </div>
